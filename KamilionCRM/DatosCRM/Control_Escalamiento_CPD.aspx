                            ...
                            <div class="Form">
                                <div class="Cell-Form">
                                    ...
                                    <div class="input-group"> 
                                        ...
                                        <asp:DropDownList ID="Drl_EstadoCPD" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                    <div class="input-group"> 
                                        <div class="input-group-addon">Estado Remedy</div>
                                        <asp:DropDownList ID="Drl_EstadoRemedy" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                    <div class="input-group"> 
                                    ...
                                    <asp:RangeValidator runat="server" Display="Dynamic" ControlToValidate="Txt_FRegCpdIni" ValidationGroup="Buscar" SetFocusOnError="True" Type="Date" MaximumValue="01/01/3000" MinimumValue="01/01/1900">Verifique las fechas, ya que el rango o el formato no es el correcto!</asp:RangeValidator>
                                    <asp:RangeValidator runat="server" Display="Dynamic" ControlToValidate="Txt_FRegCpdFin" ValidationGroup="Buscar" SetFocusOnError="True" Type="Date" MaximumValue="01/01/3000" MinimumValue="01/01/1900">Verifique las fechas, ya que el rango o el formato no es el correcto!</asp:RangeValidator>
                                    <div class="input-group">
                                        <div class="input-group-addon">Fecha Registro CPD</div>
                                        <asp:TextBox ID="Txt_FRegCpdIni" runat="server" MaxLength="10" Placeholder="DD/MM/YYYY" CssClass="form-control Fecha" />
                                        <div class="input-group-addon">-</div>
                                        <asp:TextBox ID="Txt_FRegCpdFin" runat="server" MaxLength="10" Placeholder="DD/MM/YYYY" CssClass="form-control Fecha" />
                                    </div>
                                    <br />
                                    <asp:Button ID="Btn_Buscar" ValidationGroup="Buscar" Text="Buscar" CssClass="btn btn-primary Desplegar_Loading" runat="server" />
                                    <asp:Button ID="Btn_Limpiar" Text="Limpiar" CssClass="btn btn-primary" runat="server" />
                        ...
                        <div class="bordes">
                            <asp:GridView ID="Dtg_General" runat="server" AllowPaging="True" PageSize="100" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" Style="font-size: x-small" EnableModelValidation="True">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="fcregcpd" HeaderText="Fecha Registro CPD" />
