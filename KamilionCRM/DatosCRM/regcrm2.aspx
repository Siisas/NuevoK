                    ...
                    <article>
                        ...
                        <section>
                                ...
                                <div class="Cell-Form">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <asp:Button ID="Btn_Consultar" runat="server" ValidationGroup="VG_Consultar" Text="Buscar" CssClass="btn btn-crm Desplegar_Loading" />
                                        </span>
                                    </div>
                                </div>
                                <%--CELDA DEL CENTRO--%>
                            ...
                            <div class="Form">
                                <div class="Cell-Form">
                                    <div class="input-group">
                                        <asp:Button ID="btnguardar" runat="server" Text="Guardar" ValidationGroup="VG_Registrar" CssClass="btn btn-crm Desplegar_Loading" />
                                    </div>
                                </div>
                                <%--CELDA DEL CENTRO--%>
                                <div class="Space-Form"></div>
                        ...
                        <asp:Panel ID="Panel_seguimiento" runat="server" Visible="false" CssClass="Section">
                        ...
                        <%-------asignados--------%>
                        <asp:Panel ID="PanelCasosAsignados" runat="server" CssClass="Section">
                            <div class="Leyendas">
                                Casos Asignados:
