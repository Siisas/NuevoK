            ...
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    ...
                    <article>
                        <section>
                            ...
                            <div class="Form">
                                <div class="Cell-Form">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <asp:Button ID="BtnBuscar" CssClass="btn btn-crm Desplegar_Loading" Text="Buscar" runat="server" ValidationGroup="VG_Consultar"/>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="Cell-Form">
                                    ...
                                    <asp:Button ID="BtnNuevo_caso" CssClass="btn btn-crm Desplegar_Loading" Text="Nuevo Caso" Visible="false" runat="server" />
                            ...
                            <div class="Form">
                                <asp:Button Text="Guardar" ID="Btn_Guardar" ValidationGroup="VG_Registrar" CssClass="btn btn-crm Desplegar_Loading" runat="server" />
                            </div>
                            <div class="Form">
                                <div class="Cell-Form">
                                    <div class="input-group">
                                    ...
                                    <%--Ubicacion call--%>
                                    <div class="input-group">
                                        <div class="input-group-addon">Call transfiere</div>
                        ...
                        <asp:Panel ID="Pnl_Esc_Service" runat="server" Visible="False" CssClass="Section">
                            ...
                            <div class="Form">
                                ...
                                <div class="Space-Form"></div>
                                <div class="Cell-Form">
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtfcactivacion" Display="Dynamic"  ValidationGroup="VG_Registrar"  Operator="DataTypeCheck" Type="Date">La fecha de activacion no es válida</asp:CompareValidator>
                                    <div class="input-group">
                        ...
                        <asp:Panel ID="Pnfallared" runat="server" Visible="False" CssClass="Section">
                        ...
                        <asp:Panel ID="pnnuevo" runat="server" Visible="False" CssClass="Section">
                            ...
                            <div class="Form">
                                <div class="Cell-Form">
                                    ...
                                    <asp:Button ID="Btn_Nuevo_Regist_Inb" TabIndex="38" runat="server" Text="Guardar" CssClass="btn btn-crm Desplegar_Loading" />
                                </div>
                                <div class="Space-Form"></div>
                                <div class="Cell-Form">
                                    <div class="input-group">
                        ...
                        <asp:Panel ID="Pninc" runat="server" Visible="False" CssClass="Section">
                            ...
                            <div class="Form">
                                ...
                                <asp:Button Text="Guardar" ID="Btn_Guardar_Inconsistencia" CssClass="btn btn-crm Desplegar_Loading" ValidationGroup="Vg_Reg_Insconsistencia" runat="server" />
                            </div>
                        </asp:Panel>
                        <asp:Panel runat="server" ID="Pnl_CasAsig" CssClass="Section">
                            <div class="Leyendas">
                                Casos Asignados: <asp:Label ID="lblcasos_asig" runat="server"></asp:Label>
                            </div>
                            <div class="bordes">
                        ...
                        <asp:Panel runat="server" ID="Pnl_CasGest">
                            <div class="Leyendas">
